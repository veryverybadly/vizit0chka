...
function handleRedirect() {
    ...
    if (path && links[path]) {
        ...
        window.location.href = links[path].url;
        ...
        document.body.innerHTML = `
            <div style="text-align: center; padding: 50px; font-family: Arial, sans-serif;">
                ...
                <p>Короткая ссылка "${path}" не существует или была удалена.</p>
                <a href="/" style="color: #667eea; text-decoration: none;">← Создать новую ссылку</a>
            </div>
        `;
    }
}

// Админ-панель для просмотра статистики (доступна по /admin)
